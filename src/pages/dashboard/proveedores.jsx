...
export function Proveedores() {
  ...
  const validateForm = () => {
    ...
    if (!selectedProveedor.asesor.trim()) {
      errors.asesor = 'Por favor, ingrese el nombre del asesor';
      isValid = false;
  ...
  return (
    <>
                    ...
                    <tr key={proveedor.id_proveedor}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex space-x-1">
                          ...
                          <IconButton className="btncancelarm" size="sm" onClick={() => handleDelete(proveedor)}>
                            <TrashIcon className="h-4 w-4" />
                          </IconButton>
                          <IconButton className="btnvisualizar" size="sm" onClick={() => handleViewDetails(proveedor)}>
      ...
      <Dialog open={detailsOpen} onClose={handleDetailsOpen} className="details-modal">
        <DialogHeader className="bg-gradient-to-r from-pink-200 to-pink-500 text-white text-lg font-semibold">
          Detalles del Proveedor
        </DialogHeader>
        <DialogBody className="p-4 flex flex-col items-center">
          <div className="flex flex-col space-y-2 w-full max-w-xs">
            ...
            <div className="flex justify-between">
              ...
              <span>{selectedProveedor.asesor}</span>
            </div>
          </div>
        </DialogBody>
        <DialogFooter className="flex justify-center">
          <Button
            ...
            className="mt-4 py-2 px-4 rounded-lg bg-gradient-to-r from-pink-200 to-pink-500 text-white font-semibold hover:bg-pink-600 focus:outline-none"
          >
            Cerrar
          </Button>
        </DialogFooter>
